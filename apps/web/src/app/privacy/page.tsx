        ...
        <article className="max-w-3xl mx-auto prose prose-neutral">
          ...
          <section className="mb-8">
            ...
            <p className="text-[#5C5C5C] leading-relaxed">
              TempoMap (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is a
              metronome application designed for musicians. We are committed to
          ...
          <section className="mb-8">
            ...
            <p className="text-[#5C5C5C] leading-relaxed mb-3">
              If you choose to create an account for cloud sync features, we
              collect:
            </p>
            ...
            <p className="text-[#5C5C5C] leading-relaxed">
              The app stores preferences locally on your device. This data never
              leaves your device unless you enable cloud sync.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-[#5C5C5C] leading-relaxed">
              Your data is stored securely using Convex, which provides
              enterprise-grade security including encryption at rest and in
              transit. Authentication is handled by Clerk. We do not sell, rent,
          ...
          <section className="mb-8">
            ...
            <p className="text-[#5C5C5C] leading-relaxed">
              TempoMap does not knowingly collect information from children
              under 13. The app is suitable for all ages and does not require
              personal information to function.
            </p>
          </section>
