      ...
      <main className="flex-1 py-12 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <section className="card p-6 mb-8">
            ...
            <EmailButton />
            <p className="text-[#8C8C8C] text-sm mt-3">{EMAIL}</p>
          </section>
            ...
            <div className="space-y-4">
              <div className="card p-5">
                <h3 className="font-medium text-[#1A1A1A] mb-2">
                  How do I sync my tempo maps across devices?
                </h3>
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  Create a free account in the app or on our website. Once
                  signed in, your tempo maps will automatically sync across all
                  your devices.
                </p>
              </div>
              ...
              <div className="card p-5">
                ...
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  Yes! The metronome works completely offline without an
                  account. An account is only needed if you want to sync tempo
                  maps from uploaded sheet music.
                </p>
              </div>

              <div className="card p-5">
                <h3 className="font-medium text-[#1A1A1A] mb-2">
                  How do I upload sheet music?
                </h3>
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  Log in to the web dashboard, go to a show, and upload your
                  PDF. Our AI will extract tempo markings, time signatures, and
                  rehearsal marks automatically.
                </p>
              </div>
              ...
              <div className="card p-5">
                ...
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  We currently support PDF files. Both scanned and digital sheet
                  music work, though digital PDFs typically produce more
                  accurate results.
                </p>
              </div>
              ...
              <div className="card p-5">
                ...
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  Email us at {EMAIL} and we&apos;ll delete your account and all
              ...
              <div className="card p-5">
                ...
                <p className="text-[#5C5C5C] text-sm leading-relaxed">
                  Yes. We use Clerk for authentication and Convex for data
                  storage, both providing enterprise-grade security with
                  encryption at rest and in transit. See our{' '}
                  <Link
                    href="/privacy"
